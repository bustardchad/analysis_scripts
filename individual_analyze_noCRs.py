...
dir = './crbeta1/corrected/streaming/Mach015/iso_MHD/beta100/'
...
time, mass, ke1, ke2, ke3, me1, me2, me3 = np.loadtxt(dir+'cr.hst',skiprows = 2, usecols = (0,2,6,7,8,9,10,11),unpack=True)
...
# new -- total energy
plt.semilogy(timeeddy,np.array(metot) + np.array(ketot),linewidth=1)
plt.xlabel(r'$t/ \tau_{eddy}$',fontsize=18)
...
totE_codeunits = (np.array(metot) + np.array(ketot))/edenstocgs
